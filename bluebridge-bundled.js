        ...
        while (index--) {
          ...
          if (thisProps) {
            if (destination.value && typeof thisProps.set === 'function') {
              ...
              var descProp;
              while (descProp = descriptorProps.pop()) {
                // iterate over property descriptor and copy each property from one to
...
$__System.registerDynamic('7', ['6'], true, function ($__require, exports, module) {
  ...
  exports = module.exports = $__require('6');
  exports.log = log;
...
$__System.registerDynamic('13', ['c', '12'], true, function ($__require, exports, module) {
  var define,
      global = this || self,
      GLOBAL = global;
  var traverse = $__require('c');
  var serializeError = $__require('12');
...
$__System.registerDynamic('14', ['8', 'c', 'a', '13'], true, function ($__require, exports, module) {
  var define,
      global = this || self,
      GLOBAL = global;
  var logger = $__require('8');
  var traverse = $__require('c');
  var co = $__require('a');
  var errToPOJO = $__require('13');
  var noop = function () {};
  ...
  module.exports = function (socket, tree, clientOrServer) {
    ...
    socket.on('disconnect', function onDisconnect() {
      ...
      if (method && method.apply) {
        // we could also check if it is a function, but this might be bit faster
        var retVal;
...
$__System.registerDynamic('18', ['3', '15', '17'], true, function ($__require, exports, module) {
  var define,
      global = this || self,
      GLOBAL = global;
  $__require('3');

  var socketHandlers = $__require('15');
  var io = $__require('17');
  var backends = {};
...
$__System.registerDynamic("1", ["19", "1b"], true, function ($__require, exports, module) {
  'use strict';
  ...
  var rpcClient = $__require("19");
  var EventEmitter = $__require("1b");

  /**
   * Provides client side bindings to serverside bluebridge RPC methods
   */

  var BlueBridge = function (_EventEmitter) {
    _inherits(BlueBridge, _EventEmitter);

    function BlueBridge() {
      _classCallCheck(this, BlueBridge);

      var _this = _possibleConstructorReturn(this, (BlueBridge.__proto__ || Object.getPrototypeOf(BlueBridge)).call(this));
    ...
    _createClass(BlueBridge, [{
      key: 'auth',
      value: function auth(type, opts) {
      ...
      key: 'save',
      value: function save(collection, documentId, data) {
        return this.rpc(collection + '.save')(documentId, data);
      }
    }, {
      key: 'validate',
      value: function validate(collection, documentId, data) {
        return this.rpc(collection + '.validate')(documentId, data);
      }
    }, {
      key: 'method',
      value: function method(collection, documentId, methodName) {
        return this.rpc(collection + '.methods.' + methodName).bind(this.rpc, documentId);
      }
    }, {
      key: 'static',
      value: function _static(collection, staticName) {
      ...
      value: function initialize(data) {
        ...
        this.rpc.socket.once('auth', function () {
          _this2.ready = true;
          _this2.emit('ready');
        });
      }
...
//# sourceMappingURL=bluebridge-bundled.js.map